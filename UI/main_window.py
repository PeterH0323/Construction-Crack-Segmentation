...
"")
        ...
        self.output_mask_media_tabWidget = QtWidgets.QTabWidget(self.groupBox_2)
        self.output_mask_media_tabWidget.setObjectName("output_mask_media_tabWidget")
        self.tab_13 = QtWidgets.QWidget()
        self.tab_13.setObjectName("tab_13")
        self.horizontalLayout_30 = QtWidgets.QHBoxLayout(self.tab_13)
        self.horizontalLayout_30.setObjectName("horizontalLayout_30")
        self.output_mask_video_widget = QVideoWidget(self.tab_13)
        self.output_mask_video_widget.setMinimumSize(QtCore.QSize(100, 100))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        self.output_mask_video_widget.setFont(font)
        self.output_mask_video_widget.setObjectName("output_mask_video_widget")
        self.horizontalLayout_30.addWidget(self.output_mask_video_widget)
        self.output_mask_media_tabWidget.addTab(self.tab_13, "")
        self.tab_14 = QtWidgets.QWidget()
        self.tab_14.setObjectName("tab_14")
        self.horizontalLayout_31 = QtWidgets.QHBoxLayout(self.tab_14)
        self.horizontalLayout_31.setObjectName("horizontalLayout_31")
        self.output_mask_real_time_label = QtWidgets.QLabel(self.tab_14)
        self.output_mask_real_time_label.setObjectName("output_mask_real_time_label")
        self.horizontalLayout_31.addWidget(self.output_mask_real_time_label)
        self.output_mask_media_tabWidget.addTab(self.tab_14, "")
        self.verticalLayout_2.addWidget(self.output_mask_media_tabWidget)
...
"")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:/Users/PeterH/.designer/backup/icon/play.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("C:/Users/PeterH/.designer/backup/icon/pause.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.verticalLayout_8.addWidget(self.gpu_info_chart)
        ...
        self.output_mask_media_tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.author_label_2.setText(_translate("MainWindow", "Image Segmentation System for Crack Detection"))
        ...
        self.output_mask_media_tabWidget.setTabText(self.output_mask_media_tabWidget.indexOf(self.tab_13), _translate("MainWindow", "结果"))
        self.output_mask_real_time_label.setText(_translate("MainWindow", "HinGwenWoong"))
        self.output_mask_media_tabWidget.setTabText(self.output_mask_media_tabWidget.indexOf(self.tab_14), _translate("MainWindow", "实时推理"))
