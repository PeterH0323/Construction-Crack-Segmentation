...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default="custom_dataset", help="dataset: cityscapes or camvid")
    ...
    parser.add_argument('--use_lovaszsoftmax', action='store_true', default=True,
...
def train_model(args):
    ...
    if args.dataset == 'camvid':
        ...
        criteria = CrossEntropyLoss2dLabelSmooth(weight=weight, ignore_label=ignore_label)
    elif (args.dataset == 'cityscapes' or args.dataset == 'custom_dataset') and args.use_lovaszsoftmax:
        criteria = LovaszSoftmax(ignore_index=ignore_label)
    elif (args.dataset == 'cityscapes' or args.dataset == 'custom_dataset') and args.use_focal:
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        # validation
        if epoch % save_stuff_interval == 0 or epoch == (args.max_epochs - 1):
        ...
        elif args.dataset == 'cityscapes' or args.dataset == 'custom_dataset':
            if epoch >= args.max_epochs - 10:
                torch.save(state, model_file_name)
            elif not epoch % save_stuff_interval:
                torch.save(state, model_file_name)
